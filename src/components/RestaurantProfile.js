...
import RatingLable from './RatingLable';
        ...
        <table className="table">
          <tbody>
            <tr>
              <td>Rating</td>
              <td>
                <RatingLable labelColor={props.restaurant.user_rating.rating_color} text={`${props.restaurant.user_rating.aggregate_rating} (${props.restaurant.user_rating.rating_text})`} />
              </td>
            </tr>
            <tr>
              <td>Cuisines</td>
